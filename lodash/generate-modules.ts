...
function writeModulesDts() {
    const content = moduleNames.map(declaration).join("\n");
    fs.writeFileSync("modules.d.ts", content);

    function declaration(name: string) {
        return `declare module "lodash.${name}" {
